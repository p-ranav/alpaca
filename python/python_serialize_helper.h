...
template <options OPTIONS, class It>
void parse_unordered_map(const std::string& key_value_type, It it, std::vector<uint8_t>& result, std::size_t& byte_index) {
...
template <options OPTIONS, class It>
void parse_unordered_set(const std::string& value_type, It it, std::vector<uint8_t>& result, std::size_t& byte_index) {
