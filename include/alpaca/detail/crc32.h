...
#endif
#ifndef __ALPACA_BIG_ENDIAN
#define __ALPACA_BIG_ENDIAN 4321
#endif
...
static inline uint32_t crc32_bitwise(const void *data, size_t length,
...
static inline uint32_t crc32_halfbyte(const void *data, size_t length,
                                      uint32_t previousCrc32 = 0) {
  uint32_t crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
  const uint8_t *current = (const uint8_t *)data;
...
static inline uint32_t crc32_1byte(const void *data, size_t length,
                                   uint32_t previousCrc32 = 0) {
  uint32_t crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
  const uint8_t *current = (const uint8_t *)data;
...
static inline uint32_t crc32_1byte_tableless(const void *data, size_t length,
                                             uint32_t previousCrc32 = 0) {
  uint32_t crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
  const uint8_t *current = (const uint8_t *)data;
...
/// compute CRC32 (byte algorithm) without lookup tables
static inline uint32_t crc32_1byte_tableless2(const void *data, size_t length,
                                              uint32_t previousCrc32 = 0) {
  int32_t crc = ~previousCrc32; // note: signed integer, right shift distributes
                                // sign bit into lower bits
  const uint8_t *current = (const uint8_t *)data;
  ...
  while (length-- != 0) {
    ...
    uint32_t c =
        (((crc << 31) >> 31) & ((Polynomial >> 7) ^ (Polynomial >> 1))) ^
...
static inline uint32_t crc32_4bytes(const void *data, size_t length,
                                    uint32_t previousCrc32 = 0) {
  uint32_t crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
...
static inline uint32_t crc32_8bytes(const void *data, size_t length,
                                    uint32_t previousCrc32 = 0) {
  uint32_t crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
  const uint32_t *current = (const uint32_t *)data;
...
static inline uint32_t crc32_4x8bytes(const void *data, size_t length,
                                      uint32_t previousCrc32 = 0) {
  uint32_t crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
  const uint32_t *current = (const uint32_t *)data;
...
static inline uint32_t crc32_16bytes(const void *data, size_t length,
                                     uint32_t previousCrc32 = 0) {
  uint32_t crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
  const uint32_t *current = (const uint32_t *)data;
...
static inline uint32_t crc32_16bytes_prefetch(const void *data, size_t length,
                                              uint32_t previousCrc32 = 0,
...
static inline uint32_t crc32_fast(const void *data, size_t length,
                                  uint32_t previousCrc32 = 0) {
#ifdef CRC32_USE_LOOKUP_TABLE_SLICING_BY_16
...
/// lengthA))
static inline uint32_t crc32_combine(uint32_t crcA, uint32_t crcB,
                                     size_t lengthB) {
