...
TEST_CASE("Serialize list<char> into array" * test_suite("vector")) {
  struct my_struct {
    std::list<char> value;
  };
...
TEST_CASE("Serialize list<uint64_t> into array" * test_suite("vector")) {
  struct my_struct {
    std::list<uint64_t> value;
  };
...
TEST_CASE("Serialize list<int> into array" * test_suite("vector")) {
  struct my_struct {
    std::list<int> value;
  };
...
TEST_CASE("Serialize list<float> into array" * test_suite("vector")) {
  struct my_struct {
...
#ifndef __APPLE__
TEST_CASE("Serialize list<bool> into array" * test_suite("vector")) {
  struct my_struct {
    std::list<bool> value;
  };
...
TEST_CASE("Serialize list<std::string> into array" * test_suite("vector")) {
  struct my_struct {
...
TEST_CASE("Serialize list<list<int>> into array" * test_suite("vector")) {
  struct my_struct {
    std::list<std::list<int>> value;
  };
...
TEST_CASE("Serialize list<tuple> into array" * test_suite("vector")) {
  struct my_struct {
    std::list<std::tuple<bool, int, float, std::string, char>> values;
  };
