...
TEST_CASE("Serialize deque<char> into array" * test_suite("vector")) {
  struct my_struct {
...
TEST_CASE("Serialize deque<uint64_t> into array" * test_suite("vector")) {
  struct my_struct {
...
TEST_CASE("Serialize deque<int> into array" * test_suite("vector")) {
  struct my_struct {
    std::deque<int> value;
  };
...
TEST_CASE("Serialize deque<float> into array" * test_suite("vector")) {
  struct my_struct {
...
#ifndef __APPLE__
TEST_CASE("Serialize deque<bool> into array" * test_suite("vector")) {
  struct my_struct {
...
TEST_CASE("Serialize deque<std::string> into array" * test_suite("vector")) {
  struct my_struct {
...
TEST_CASE("Serialize deque<deque<int>> into array" * test_suite("vector")) {
  struct my_struct {
...
TEST_CASE("Serialize deque<tuple> into array" * test_suite("vector")) {
  struct my_struct {
