...
TEST_CASE("Serialize list<char>" * test_suite("vector")) {
  struct my_struct {
    std::list<char> value;
  };
...
TEST_CASE("Serialize list<uint64_t>" * test_suite("vector")) {
  struct my_struct {
...
TEST_CASE("Serialize list<int>" * test_suite("vector")) {
  struct my_struct {
    std::list<int> value;
  };
...
TEST_CASE("Serialize list<float>" * test_suite("vector")) {
  struct my_struct {
...
#ifndef __APPLE__
TEST_CASE("Serialize list<bool>" * test_suite("vector")) {
  struct my_struct {
    std::list<bool> value;
  };
...
TEST_CASE("Serialize list<std::string>" * test_suite("vector")) {
  struct my_struct {
...
TEST_CASE("Serialize list<list<int>>" * test_suite("vector")) {
  struct my_struct {
...
TEST_CASE("Serialize list<tuple>" * test_suite("vector")) {
  struct my_struct {
